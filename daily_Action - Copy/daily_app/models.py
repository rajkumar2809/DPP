...
class ProjectNotes (models.Model):
    ...
    catagory = models.CharField(max_length=150 , null=True , blank=True)
    CATAGORY = (
        ('DOCUMENT-COLLECTION', 'DOCUMENT-COLLECTION'),
        ('DOCUMENTATION', 'DOCUMENTATION'),
        ('CLIENT-MEETING', 'CLIENT-MEETING'),
    )
    catagory = models.CharField(_('Status'), default="DOCUMENTATION" , max_length=50, choices=CATAGORY , null=True)
